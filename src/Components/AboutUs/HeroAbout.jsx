    ...
    <div className=" p-3 py-5 md:mx-20">
      <div className="flex  space-x-4">
        ...
        <div className="py-2 md:w-[50%] my-auto space-y-4">
          ...
          <div>
            <p className="font-bold text-lg md:text-xl m-0">Our Services</p>
          ...
          {style != 1 && (
            <div>
              <Link to="/about-us">
                <button
                  type="button"
                  class=" bg-green-900 text-white p-2 px-3 rounded-md font-semibold font-serif hover:bg-green-700 duration-500 text-sm ms:text-base"
                >
                  More About Us
                </button>
              </Link>
